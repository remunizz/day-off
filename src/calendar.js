		...
		for ( let i = 0; i < weekDays; ++i ) {
			...
			for ( let j = 0; j < weekDays; ++j ) {
				...
				if ( isBufferFirstLine ) {
					...
					headerColumns += replace( localization.WeekDayFormat, [ localization.weekDaysNames[ j ] ] ).white
				}
				...
				} else if ( dayNum == date.getUTCDate() && firstDayOfMonth.getMonth() == date.getMonth() ) {
